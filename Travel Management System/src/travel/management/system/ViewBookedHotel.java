...
public class ViewBookedHotel extends JFrame {
    ...
    public ViewBookedHotel(String username) {
        ...
        JLabel lblCountry = new JLabel("Food Included :");
        ...
        try {
            ...
            String sql =
                    "SELECT username, hotel, persons, days, ac, food, " +
                    "id_type, number, phone, price " +
                    "FROM bookHotel " +
                    "WHERE username = ? " +
            ...
            if (rs.next()) {
                ...
                l7.setText(rs.getString("id_type"));
                ...
                JOptionPane.showMessageDialog(
                        null,
                        "No hotel booking found for " + username
                );
            }
